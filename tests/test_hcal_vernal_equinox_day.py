...
class TestHcalVernalEquinoxDay(unittest.TestCase):
    ...
    def test_vernal_equinox_1948_1979(self):
        """Test dates between 1948 and 1979."""
        # 1960: March 21
    ...
    def test_vernal_equinox_pre_1948(self):
        """Test dates before 1948 (should be None/not present)."""
        # Should not be present before 1948
